-- Multi-tenant: agrega tabla `restaurants` y columna `restaurantId` a todas las entidades.
-- Compatible con datos existentes: backfill con restaurantId=1 (restaurante por defecto).
